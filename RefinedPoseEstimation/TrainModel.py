...
def main(pose_refiner_model, optimizer, training_dataloader, validation_dataloader, loss_function) -> None:
	...
	for epoch in range(1, NUM_EPOCHS):
		...
		print("SAVING MODEL")
		torch.save(pose_refiner_model.state_dict(), "{}.pt".format(MAIN_DIR_PATH + "RefinedPoseEstimation/TrainedModels/RefinedPoseEstimationModelProjection2DGrayScaleBN"))
