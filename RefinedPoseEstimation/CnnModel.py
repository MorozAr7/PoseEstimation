...
class EncoderModel(nn.Module):
    def __init__(self):
        ...
        self.Conv0 = ConvBnActiv(in_channels=self.layer_channels[0], out_channels=self.layer_channels[1], kernel_size=7,
                                 padding=3)
        ...
        self.Conv5 = ConvBnActiv(in_channels=self.layer_channels[5], out_channels=self.layer_channels[6], kernel_size=1,
                                 stride=1, apply_bn=False, apply_activation=True, padding=0, apply_bias=False)
